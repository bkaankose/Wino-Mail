...
internal sealed class MailAuthenticatorConfiguration : IAuthenticatorConfig
{
    public string OutlookAuthenticatorClientId => "b19c2035-d740-49ff-b297-de6ec561b208";

    public string GmailAuthenticatorClientId =>
        "973025879644-s7b4ur9p3rlgop6a22u7iuptdc0brnrn.apps.googleusercontent.com";
    ...
    public string[] GetOutlookScope(bool isMailAccessGranted, bool isCalendarAccessGranted)
    {
        ...
        {
            scopes.AddRange([
                "mail.readwrite", "mail.send", "Mail.Send.Shared",
                "Mail.ReadWrite.Shared", "MailboxSettings.ReadWrite"
            ]);
        }
