...
namespace Wino.Extensions
{
    public static class ColorExtensions
    {
        ...
        {
            double R = 0, G = 0, B = 0;
            double S = hsl.S * 1.0f / 255;
            double L = hsl.L * 1.0f / 255;
            ...
            G = G * 255;
            B = B * 255;
            return Color.FromArgb((byte)hsl.A, (byte)R, (byte)G, (byte)B);
        }
        ...
        internal static Color ParseColor(string color, IFormatProvider formatProvider, ITypeDescriptorContext context)
        {
            ...
            bool isScRgbColor;
            bool isContextColor;
            string trimmedColor = KnownColors.MatchColor(color, out isPossibleKnowColor, out isNumericColor,
                                                         out isContextColor, out isScRgbColor);
            ...
            else
            {
                ...
                return WellkownColors.FromUInt32((uint)kc);
            }
        }
    ...
    internal static class KnownColors
    {
        ...
        public static SolidColorBrush SolidColorBrushFromUint(uint argb)
        {
            ...
            lock (s_solidColorBrushCache)
            {
                ...
                {
                    scp = new SolidColorBrush(WellkownColors.FromUInt32(argb));
    ...
    /// </summary>
    public sealed class WellkownColors
    {
        #region Constructors

        // Colors only has static members, so it shouldn't be constructable.
        private WellkownColors()
        {
        }

        #endregion Constructors

        public static Color FromUInt32(uint colorCode)
        {
            uint alpha = (colorCode & 0xFF000000) >> 24;
            var red = (colorCode & 0x00FF0000) >> 16;
            var green = (colorCode & 0x0000FF00) >> 8;
            var blue = (colorCode & 0x000000FF) >> 0;
        ...
        /// </summary>
        public static Color AliceBlue => FromUInt32((uint)KnownColor.AliceBlue);

        /// <summary>
        /// Well-known color: AntiqueWhite
        /// </summary>
        public static Color AntiqueWhite => FromUInt32((uint)KnownColor.AntiqueWhite);

        /// <summary>
        /// Well-known color: Aqua
        /// </summary>
        public static Color Aqua => FromUInt32((uint)KnownColor.Aqua);

        /// <summary>
        /// Well-known color: Aquamarine
        /// </summary>
        public static Color Aquamarine => FromUInt32((uint)KnownColor.Aquamarine);

        /// <summary>
        /// Well-known color: Azure
        /// </summary>
        public static Color Azure => FromUInt32((uint)KnownColor.Azure);

        /// <summary>
        /// Well-known color: Beige
        /// </summary>
        public static Color Beige => FromUInt32((uint)KnownColor.Beige);

        /// <summary>
        /// Well-known color: Bisque
        /// </summary>
        public static Color Bisque => FromUInt32((uint)KnownColor.Bisque);

        /// <summary>
        /// Well-known color: Black
        /// </summary>
        public static Color Black => FromUInt32((uint)KnownColor.Black);

        /// <summary>
        /// Well-known color: BlanchedAlmond
        /// </summary>
        public static Color BlanchedAlmond => FromUInt32((uint)KnownColor.BlanchedAlmond);

        /// <summary>
        /// Well-known color: Blue
        /// </summary>
        public static Color Blue => FromUInt32((uint)KnownColor.Blue);

        /// <summary>
        /// Well-known color: BlueViolet
        /// </summary>
        public static Color BlueViolet => FromUInt32((uint)KnownColor.BlueViolet);

        /// <summary>
        /// Well-known color: Brown
        /// </summary>
        public static Color Brown => FromUInt32((uint)KnownColor.Brown);

        /// <summary>
        /// Well-known color: BurlyWood
        /// </summary>
        public static Color BurlyWood => FromUInt32((uint)KnownColor.BurlyWood);

        /// <summary>
        /// Well-known color: CadetBlue
        /// </summary>
        public static Color CadetBlue => FromUInt32((uint)KnownColor.CadetBlue);

        /// <summary>
        /// Well-known color: Chartreuse
        /// </summary>
        public static Color Chartreuse => FromUInt32((uint)KnownColor.Chartreuse);

        /// <summary>
        /// Well-known color: Chocolate
        /// </summary>
        public static Color Chocolate => FromUInt32((uint)KnownColor.Chocolate);

        /// <summary>
        /// Well-known color: Coral
        /// </summary>
        public static Color Coral => FromUInt32((uint)KnownColor.Coral);

        /// <summary>
        /// Well-known color: CornflowerBlue
        /// </summary>
        public static Color CornflowerBlue => FromUInt32((uint)KnownColor.CornflowerBlue);

        /// <summary>
        /// Well-known color: Cornsilk
        /// </summary>
        public static Color Cornsilk => FromUInt32((uint)KnownColor.Cornsilk);

        /// <summary>
        /// Well-known color: Crimson
        /// </summary>
        public static Color Crimson => FromUInt32((uint)KnownColor.Crimson);

        /// <summary>
        /// Well-known color: Cyan
        /// </summary>
        public static Color Cyan => FromUInt32((uint)KnownColor.Cyan);

        /// <summary>
        /// Well-known color: DarkBlue
        /// </summary>
        public static Color DarkBlue => FromUInt32((uint)KnownColor.DarkBlue);

        /// <summary>
        /// Well-known color: DarkCyan
        /// </summary>
        public static Color DarkCyan => FromUInt32((uint)KnownColor.DarkCyan);

        /// <summary>
        /// Well-known color: DarkGoldenrod
        /// </summary>
        public static Color DarkGoldenrod => FromUInt32((uint)KnownColor.DarkGoldenrod);

        /// <summary>
        /// Well-known color: DarkGray
        /// </summary>
        public static Color DarkGray => FromUInt32((uint)KnownColor.DarkGray);

        /// <summary>
        /// Well-known color: DarkGreen
        /// </summary>
        public static Color DarkGreen => FromUInt32((uint)KnownColor.DarkGreen);

        /// <summary>
        /// Well-known color: DarkKhaki
        /// </summary>
        public static Color DarkKhaki => FromUInt32((uint)KnownColor.DarkKhaki);

        /// <summary>
        /// Well-known color: DarkMagenta
        /// </summary>
        public static Color DarkMagenta => FromUInt32((uint)KnownColor.DarkMagenta);

        /// <summary>
        /// Well-known color: DarkOliveGreen
        /// </summary>
        public static Color DarkOliveGreen => FromUInt32((uint)KnownColor.DarkOliveGreen);

        /// <summary>
        /// Well-known color: DarkOrange
        /// </summary>
        public static Color DarkOrange => FromUInt32((uint)KnownColor.DarkOrange);

        /// <summary>
        /// Well-known color: DarkOrchid
        /// </summary>
        public static Color DarkOrchid => FromUInt32((uint)KnownColor.DarkOrchid);

        /// <summary>
        /// Well-known color: DarkRed
        /// </summary>
        public static Color DarkRed => FromUInt32((uint)KnownColor.DarkRed);

        /// <summary>
        /// Well-known color: DarkSalmon
        /// </summary>
        public static Color DarkSalmon => FromUInt32((uint)KnownColor.DarkSalmon);

        /// <summary>
        /// Well-known color: DarkSeaGreen
        /// </summary>
        public static Color DarkSeaGreen => FromUInt32((uint)KnownColor.DarkSeaGreen);

        /// <summary>
        /// Well-known color: DarkSlateBlue
        /// </summary>
        public static Color DarkSlateBlue => FromUInt32((uint)KnownColor.DarkSlateBlue);

        /// <summary>
        /// Well-known color: DarkSlateGray
        /// </summary>
        public static Color DarkSlateGray => FromUInt32((uint)KnownColor.DarkSlateGray);

        /// <summary>
        /// Well-known color: DarkTurquoise
        /// </summary>
        public static Color DarkTurquoise => FromUInt32((uint)KnownColor.DarkTurquoise);

        /// <summary>
        /// Well-known color: DarkViolet
        /// </summary>
        public static Color DarkViolet => FromUInt32((uint)KnownColor.DarkViolet);

        /// <summary>
        /// Well-known color: DeepPink
        /// </summary>
        public static Color DeepPink => FromUInt32((uint)KnownColor.DeepPink);

        /// <summary>
        /// Well-known color: DeepSkyBlue
        /// </summary>
        public static Color DeepSkyBlue => FromUInt32((uint)KnownColor.DeepSkyBlue);

        /// <summary>
        /// Well-known color: DimGray
        /// </summary>
        public static Color DimGray => FromUInt32((uint)KnownColor.DimGray);

        /// <summary>
        /// Well-known color: DodgerBlue
        /// </summary>
        public static Color DodgerBlue => FromUInt32((uint)KnownColor.DodgerBlue);

        /// <summary>
        /// Well-known color: Firebrick
        /// </summary>
        public static Color Firebrick => FromUInt32((uint)KnownColor.Firebrick);

        /// <summary>
        /// Well-known color: FloralWhite
        /// </summary>
        public static Color FloralWhite => FromUInt32((uint)KnownColor.FloralWhite);

        /// <summary>
        /// Well-known color: ForestGreen
        /// </summary>
        public static Color ForestGreen => FromUInt32((uint)KnownColor.ForestGreen);

        /// <summary>
        /// Well-known color: Fuchsia
        /// </summary>
        public static Color Fuchsia => FromUInt32((uint)KnownColor.Fuchsia);

        /// <summary>
        /// Well-known color: Gainsboro
        /// </summary>
        public static Color Gainsboro => FromUInt32((uint)KnownColor.Gainsboro);

        /// <summary>
        /// Well-known color: GhostWhite
        /// </summary>
        public static Color GhostWhite => FromUInt32((uint)KnownColor.GhostWhite);

        /// <summary>
        /// Well-known color: Gold
        /// </summary>
        public static Color Gold => FromUInt32((uint)KnownColor.Gold);

        /// <summary>
        /// Well-known color: Goldenrod
        /// </summary>
        public static Color Goldenrod => FromUInt32((uint)KnownColor.Goldenrod);

        /// <summary>
        /// Well-known color: Gray
        /// </summary>
        public static Color Gray => FromUInt32((uint)KnownColor.Gray);

        /// <summary>
        /// Well-known color: Green
        /// </summary>
        public static Color Green => FromUInt32((uint)KnownColor.Green);

        /// <summary>
        /// Well-known color: GreenYellow
        /// </summary>
        public static Color GreenYellow => FromUInt32((uint)KnownColor.GreenYellow);

        /// <summary>
        /// Well-known color: Honeydew
        /// </summary>
        public static Color Honeydew => FromUInt32((uint)KnownColor.Honeydew);

        /// <summary>
        /// Well-known color: HotPink
        /// </summary>
        public static Color HotPink => FromUInt32((uint)KnownColor.HotPink);

        /// <summary>
        /// Well-known color: IndianRed
        /// </summary>
        public static Color IndianRed => FromUInt32((uint)KnownColor.IndianRed);

        /// <summary>
        /// Well-known color: Indigo
        /// </summary>
        public static Color Indigo => FromUInt32((uint)KnownColor.Indigo);

        /// <summary>
        /// Well-known color: Ivory
        /// </summary>
        public static Color Ivory => FromUInt32((uint)KnownColor.Ivory);

        /// <summary>
        /// Well-known color: Khaki
        /// </summary>
        public static Color Khaki => FromUInt32((uint)KnownColor.Khaki);

        /// <summary>
        /// Well-known color: Lavender
        /// </summary>
        public static Color Lavender => FromUInt32((uint)KnownColor.Lavender);

        /// <summary>
        /// Well-known color: LavenderBlush
        /// </summary>
        public static Color LavenderBlush => FromUInt32((uint)KnownColor.LavenderBlush);

        /// <summary>
        /// Well-known color: LawnGreen
        /// </summary>
        public static Color LawnGreen => FromUInt32((uint)KnownColor.LawnGreen);

        /// <summary>
        /// Well-known color: LemonChiffon
        /// </summary>
        public static Color LemonChiffon => FromUInt32((uint)KnownColor.LemonChiffon);

        /// <summary>
        /// Well-known color: LightBlue
        /// </summary>
        public static Color LightBlue => FromUInt32((uint)KnownColor.LightBlue);

        /// <summary>
        /// Well-known color: LightCoral
        /// </summary>
        public static Color LightCoral => FromUInt32((uint)KnownColor.LightCoral);

        /// <summary>
        /// Well-known color: LightCyan
        /// </summary>
        public static Color LightCyan => FromUInt32((uint)KnownColor.LightCyan);

        /// <summary>
        /// Well-known color: LightGoldenrodYellow
        /// </summary>
        public static Color LightGoldenrodYellow => FromUInt32((uint)KnownColor.LightGoldenrodYellow);

        /// <summary>
        /// Well-known color: LightGray
        /// </summary>
        public static Color LightGray => FromUInt32((uint)KnownColor.LightGray);

        /// <summary>
        /// Well-known color: LightGreen
        /// </summary>
        public static Color LightGreen => FromUInt32((uint)KnownColor.LightGreen);

        /// <summary>
        /// Well-known color: LightPink
        /// </summary>
        public static Color LightPink => FromUInt32((uint)KnownColor.LightPink);

        /// <summary>
        /// Well-known color: LightSalmon
        /// </summary>
        public static Color LightSalmon => FromUInt32((uint)KnownColor.LightSalmon);

        /// <summary>
        /// Well-known color: LightSeaGreen
        /// </summary>
        public static Color LightSeaGreen => FromUInt32((uint)KnownColor.LightSeaGreen);

        /// <summary>
        /// Well-known color: LightSkyBlue
        /// </summary>
        public static Color LightSkyBlue => FromUInt32((uint)KnownColor.LightSkyBlue);

        /// <summary>
        /// Well-known color: LightSlateGray
        /// </summary>
        public static Color LightSlateGray => FromUInt32((uint)KnownColor.LightSlateGray);

        /// <summary>
        /// Well-known color: LightSteelBlue
        /// </summary>
        public static Color LightSteelBlue => FromUInt32((uint)KnownColor.LightSteelBlue);

        /// <summary>
        /// Well-known color: LightYellow
        /// </summary>
        public static Color LightYellow => FromUInt32((uint)KnownColor.LightYellow);

        /// <summary>
        /// Well-known color: Lime
        /// </summary>
        public static Color Lime => FromUInt32((uint)KnownColor.Lime);

        /// <summary>
        /// Well-known color: LimeGreen
        /// </summary>
        public static Color LimeGreen => FromUInt32((uint)KnownColor.LimeGreen);

        /// <summary>
        /// Well-known color: Linen
        /// </summary>
        public static Color Linen => FromUInt32((uint)KnownColor.Linen);

        /// <summary>
        /// Well-known color: Magenta
        /// </summary>
        public static Color Magenta => FromUInt32((uint)KnownColor.Magenta);

        /// <summary>
        /// Well-known color: Maroon
        /// </summary>
        public static Color Maroon => FromUInt32((uint)KnownColor.Maroon);

        /// <summary>
        /// Well-known color: MediumAquamarine
        /// </summary>
        public static Color MediumAquamarine => FromUInt32((uint)KnownColor.MediumAquamarine);

        /// <summary>
        /// Well-known color: MediumBlue
        /// </summary>
        public static Color MediumBlue => FromUInt32((uint)KnownColor.MediumBlue);

        /// <summary>
        /// Well-known color: MediumOrchid
        /// </summary>
        public static Color MediumOrchid => FromUInt32((uint)KnownColor.MediumOrchid);

        /// <summary>
        /// Well-known color: MediumPurple
        /// </summary>
        public static Color MediumPurple => FromUInt32((uint)KnownColor.MediumPurple);

        /// <summary>
        /// Well-known color: MediumSeaGreen
        /// </summary>
        public static Color MediumSeaGreen => FromUInt32((uint)KnownColor.MediumSeaGreen);

        /// <summary>
        /// Well-known color: MediumSlateBlue
        /// </summary>
        public static Color MediumSlateBlue => FromUInt32((uint)KnownColor.MediumSlateBlue);

        /// <summary>
        /// Well-known color: MediumSpringGreen
        /// </summary>
        public static Color MediumSpringGreen => FromUInt32((uint)KnownColor.MediumSpringGreen);

        /// <summary>
        /// Well-known color: MediumTurquoise
        /// </summary>
        public static Color MediumTurquoise => FromUInt32((uint)KnownColor.MediumTurquoise);

        /// <summary>
        /// Well-known color: MediumVioletRed
        /// </summary>
        public static Color MediumVioletRed => FromUInt32((uint)KnownColor.MediumVioletRed);

        /// <summary>
        /// Well-known color: MidnightBlue
        /// </summary>
        public static Color MidnightBlue => FromUInt32((uint)KnownColor.MidnightBlue);

        /// <summary>
        /// Well-known color: MintCream
        /// </summary>
        public static Color MintCream => FromUInt32((uint)KnownColor.MintCream);

        /// <summary>
        /// Well-known color: MistyRose
        /// </summary>
        public static Color MistyRose => FromUInt32((uint)KnownColor.MistyRose);

        /// <summary>
        /// Well-known color: Moccasin
        /// </summary>
        public static Color Moccasin => FromUInt32((uint)KnownColor.Moccasin);

        /// <summary>
        /// Well-known color: NavajoWhite
        /// </summary>
        public static Color NavajoWhite => FromUInt32((uint)KnownColor.NavajoWhite);

        /// <summary>
        /// Well-known color: Navy
        /// </summary>
        public static Color Navy => FromUInt32((uint)KnownColor.Navy);

        /// <summary>
        /// Well-known color: OldLace
        /// </summary>
        public static Color OldLace => FromUInt32((uint)KnownColor.OldLace);

        /// <summary>
        /// Well-known color: Olive
        /// </summary>
        public static Color Olive => FromUInt32((uint)KnownColor.Olive);

        /// <summary>
        /// Well-known color: OliveDrab
        /// </summary>
        public static Color OliveDrab => FromUInt32((uint)KnownColor.OliveDrab);

        /// <summary>
        /// Well-known color: Orange
        /// </summary>
        public static Color Orange => FromUInt32((uint)KnownColor.Orange);

        /// <summary>
        /// Well-known color: OrangeRed
        /// </summary>
        public static Color OrangeRed => FromUInt32((uint)KnownColor.OrangeRed);

        /// <summary>
        /// Well-known color: Orchid
        /// </summary>
        public static Color Orchid => FromUInt32((uint)KnownColor.Orchid);

        /// <summary>
        /// Well-known color: PaleGoldenrod
        /// </summary>
        public static Color PaleGoldenrod => FromUInt32((uint)KnownColor.PaleGoldenrod);

        /// <summary>
        /// Well-known color: PaleGreen
        /// </summary>
        public static Color PaleGreen => FromUInt32((uint)KnownColor.PaleGreen);

        /// <summary>
        /// Well-known color: PaleTurquoise
        /// </summary>
        public static Color PaleTurquoise => FromUInt32((uint)KnownColor.PaleTurquoise);

        /// <summary>
        /// Well-known color: PaleVioletRed
        /// </summary>
        public static Color PaleVioletRed => FromUInt32((uint)KnownColor.PaleVioletRed);

        /// <summary>
        /// Well-known color: PapayaWhip
        /// </summary>
        public static Color PapayaWhip => FromUInt32((uint)KnownColor.PapayaWhip);

        /// <summary>
        /// Well-known color: PeachPuff
        /// </summary>
        public static Color PeachPuff => FromUInt32((uint)KnownColor.PeachPuff);

        /// <summary>
        /// Well-known color: Peru
        /// </summary>
        public static Color Peru => FromUInt32((uint)KnownColor.Peru);

        /// <summary>
        /// Well-known color: Pink
        /// </summary>
        public static Color Pink => FromUInt32((uint)KnownColor.Pink);

        /// <summary>
        /// Well-known color: Plum
        /// </summary>
        public static Color Plum => FromUInt32((uint)KnownColor.Plum);

        /// <summary>
        /// Well-known color: PowderBlue
        /// </summary>
        public static Color PowderBlue => FromUInt32((uint)KnownColor.PowderBlue);

        /// <summary>
        /// Well-known color: Purple
        /// </summary>
        public static Color Purple => FromUInt32((uint)KnownColor.Purple);

        /// <summary>
        /// Well-known color: Red
        /// </summary>
        public static Color Red => FromUInt32((uint)KnownColor.Red);

        /// <summary>
        /// Well-known color: RosyBrown
        /// </summary>
        public static Color RosyBrown => FromUInt32((uint)KnownColor.RosyBrown);

        /// <summary>
        /// Well-known color: RoyalBlue
        /// </summary>
        public static Color RoyalBlue => FromUInt32((uint)KnownColor.RoyalBlue);

        /// <summary>
        /// Well-known color: SaddleBrown
        /// </summary>
        public static Color SaddleBrown => FromUInt32((uint)KnownColor.SaddleBrown);

        /// <summary>
        /// Well-known color: Salmon
        /// </summary>
        public static Color Salmon => FromUInt32((uint)KnownColor.Salmon);

        /// <summary>
        /// Well-known color: SandyBrown
        /// </summary>
        public static Color SandyBrown => FromUInt32((uint)KnownColor.SandyBrown);

        /// <summary>
        /// Well-known color: SeaGreen
        /// </summary>
        public static Color SeaGreen => FromUInt32((uint)KnownColor.SeaGreen);

        /// <summary>
        /// Well-known color: SeaShell
        /// </summary>
        public static Color SeaShell => FromUInt32((uint)KnownColor.SeaShell);

        /// <summary>
        /// Well-known color: Sienna
        /// </summary>
        public static Color Sienna => FromUInt32((uint)KnownColor.Sienna);

        /// <summary>
        /// Well-known color: Silver
        /// </summary>
        public static Color Silver => FromUInt32((uint)KnownColor.Silver);

        /// <summary>
        /// Well-known color: SkyBlue
        /// </summary>
        public static Color SkyBlue => FromUInt32((uint)KnownColor.SkyBlue);

        /// <summary>
        /// Well-known color: SlateBlue
        /// </summary>
        public static Color SlateBlue => FromUInt32((uint)KnownColor.SlateBlue);

        /// <summary>
        /// Well-known color: SlateGray
        /// </summary>
        public static Color SlateGray => FromUInt32((uint)KnownColor.SlateGray);

        /// <summary>
        /// Well-known color: Snow
        /// </summary>
        public static Color Snow => FromUInt32((uint)KnownColor.Snow);

        /// <summary>
        /// Well-known color: SpringGreen
        /// </summary>
        public static Color SpringGreen => FromUInt32((uint)KnownColor.SpringGreen);

        /// <summary>
        /// Well-known color: SteelBlue
        /// </summary>
        public static Color SteelBlue => FromUInt32((uint)KnownColor.SteelBlue);

        /// <summary>
        /// Well-known color: Tan
        /// </summary>
        public static Color Tan => FromUInt32((uint)KnownColor.Tan);

        /// <summary>
        /// Well-known color: Teal
        /// </summary>
        public static Color Teal => FromUInt32((uint)KnownColor.Teal);

        /// <summary>
        /// Well-known color: Thistle
        /// </summary>
        public static Color Thistle => FromUInt32((uint)KnownColor.Thistle);

        /// <summary>
        /// Well-known color: Tomato
        /// </summary>
        public static Color Tomato => FromUInt32((uint)KnownColor.Tomato);

        /// <summary>
        /// Well-known color: Transparent
        /// </summary>
        public static Color Transparent => FromUInt32((uint)KnownColor.Transparent);

        /// <summary>
        /// Well-known color: Turquoise
        /// </summary>
        public static Color Turquoise => FromUInt32((uint)KnownColor.Turquoise);

        /// <summary>
        /// Well-known color: Violet
        /// </summary>
        public static Color Violet => FromUInt32((uint)KnownColor.Violet);

        /// <summary>
        /// Well-known color: Wheat
        /// </summary>
        public static Color Wheat => FromUInt32((uint)KnownColor.Wheat);

        /// <summary>
        /// Well-known color: White
        /// </summary>
        public static Color White => FromUInt32((uint)KnownColor.White);

        /// <summary>
        /// Well-known color: WhiteSmoke
        /// </summary>
        public static Color WhiteSmoke => FromUInt32((uint)KnownColor.WhiteSmoke);

        /// <summary>
        /// Well-known color: Yellow
        /// </summary>
        public static Color Yellow => FromUInt32((uint)KnownColor.Yellow);

        /// <summary>
        /// Well-known color: YellowGreen
        /// </summary>
        public static Color YellowGreen => FromUInt32((uint)KnownColor.YellowGreen);
