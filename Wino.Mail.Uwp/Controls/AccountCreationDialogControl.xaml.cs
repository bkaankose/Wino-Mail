...
namespace Wino.Mail.Uwp.Controls;

public sealed partial class AccountCreationDialogControl : UserControl, IRecipient<CopyAuthURLRequested>
{
    private Windows.System.DispatcherQueue DispatcherQueue => Windows.System.DispatcherQueue.GetForCurrentThread();
    ...
    public async void Receive(CopyAuthURLRequested message)
    {
        ...
        {
            AuthHelpDialogButton.Visibility = Windows.UI.Xaml.Visibility.Collapsed;
        });
    }
    ...
    private void CancelButtonClicked(object sender, Windows.UI.Xaml.RoutedEventArgs e) => CancelClicked?.Invoke(this, EventArgs.Empty);
}
