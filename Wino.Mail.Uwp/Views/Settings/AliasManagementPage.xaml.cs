...
public sealed partial class AliasManagementPage : AliasManagementPageAbstract
{
    ...
    private void SetAliasPrimary_Click(object sender, Windows.UI.Xaml.RoutedEventArgs e)
    {
    ...
    private void DeleteAlias_Click(object sender, Windows.UI.Xaml.RoutedEventArgs e)
    {
    ...
    private async void SmimeClicked(object sender, Windows.UI.Xaml.RoutedEventArgs e)
    {
