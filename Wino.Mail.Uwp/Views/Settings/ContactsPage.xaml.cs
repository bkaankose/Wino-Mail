...
public sealed partial class ContactsPage : ContactsPageAbstract, ITitleBarSearchHost
{
    ...
    private void EditContact_Click(object sender, Windows.UI.Xaml.RoutedEventArgs e)
    {
    ...
    private void PickContactPhoto_Click(object sender, Windows.UI.Xaml.RoutedEventArgs e)
    {
        if (sender is Button button && button.CommandParameter is AccountContactViewModel contact)
        {
    ...
    private void DeleteContact_Click(object sender, Windows.UI.Xaml.RoutedEventArgs e)
    {
        if (sender is Button button && button.CommandParameter is AccountContactViewModel contact)
        {
    ...
    private void SelectAllContacts_Click(object sender, Windows.UI.Xaml.RoutedEventArgs e)
    {
        if (!ViewModel.IsSelectionMode)
            return;
    ...
    private void ClearSelection_Click(object sender, Windows.UI.Xaml.RoutedEventArgs e)
    {
        ClearSelection();
    }
    ...
    private void ContactsPageUnloaded(object sender, Windows.UI.Xaml.RoutedEventArgs e)
    {
        ViewModel.PropertyChanged -= ViewModelPropertyChanged;
        Unloaded -= ContactsPageUnloaded;
    }
