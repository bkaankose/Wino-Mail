...
public static class XamlHelpers
{
    ...
    public static Windows.UI.Xaml.Media.Imaging.BitmapImage? Base64ToBitmapImage(string base64String)
    {
    ...
    public static Windows.UI.Xaml.Media.Imaging.BitmapImage? StringToBitmapImage(string? imagePath)
    {
    ...
    public static Windows.UI.Xaml.Controls.NavigationViewDisplayMode NavigationViewDisplayModeConverter(SplitViewDisplayMode splitViewDisplayMode)
    {
        return splitViewDisplayMode switch
        {
            SplitViewDisplayMode.CompactOverlay => Windows.UI.Xaml.Controls.NavigationViewDisplayMode.Compact,
            SplitViewDisplayMode.CompactInline => Windows.UI.Xaml.Controls.NavigationViewDisplayMode.Minimal,
            SplitViewDisplayMode.Overlay => Windows.UI.Xaml.Controls.NavigationViewDisplayMode.Expanded,
            SplitViewDisplayMode.Inline => Windows.UI.Xaml.Controls.NavigationViewDisplayMode.Expanded,
            _ => Windows.UI.Xaml.Controls.NavigationViewDisplayMode.Minimal,
        };
    }
    ...
    private static SolidColorBrush GetDefaultBrushForUnderlyingTheme()
        => new(Wino.Mail.Uwp.WinoApplication.Current.UnderlyingThemeService.IsUnderlyingThemeDark()
            ? Colors.White
            : Colors.Black);
