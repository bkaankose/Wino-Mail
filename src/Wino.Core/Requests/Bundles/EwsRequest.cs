...
/// <summary>
/// A single Exchange operation expressed over a connected <see cref="ExchangeService"/>. The MAPI/HTTP
/// synchronizer reuses the same bundle shape and ignores the service the executor passes in.
/// </summary>
