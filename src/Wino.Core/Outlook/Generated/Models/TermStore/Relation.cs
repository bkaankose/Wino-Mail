...
#nullable enable
        public global::Microsoft.Graph.Models.TermStore.Term? FromTerm { get; set; }
#nullable restore
#else
        public global::Microsoft.Graph.Models.TermStore.Term FromTerm { get; set; }
#endif
        /// <summary>The type of relation. The possible values are: pin, reuse.</summary>
        public global::Microsoft.Graph.Models.TermStore.RelationType? Relationship { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.Models.TermStore.Term? ToTerm { get; set; }
#nullable restore
#else
        public global::Microsoft.Graph.Models.TermStore.Term ToTerm { get; set; }
#endif
