...
#nullable enable
        public List<global::Microsoft.Graph.Models.Security.HostPortBanner>? Banners { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.Models.Security.HostPortBanner> Banners { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.Models.Security.SslCertificate? MostRecentSslCertificate { get; set; }
#nullable restore
#else
        public global::Microsoft.Graph.Models.Security.SslCertificate MostRecentSslCertificate { get; set; }
#endif
        ...
        public global::Microsoft.Graph.Models.Security.HostPortProtocol? Protocol { get; set; }
        /// <summary>The hostPortComponents retrieved from scanning the port.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Models.Security.HostPortComponent>? Services { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.Models.Security.HostPortComponent> Services { get; set; }
#endif
        /// <summary>The status of the port. The possible values are: open, filtered, closed, unknownFutureValue.</summary>
        public global::Microsoft.Graph.Models.Security.HostPortStatus? Status { get; set; }
