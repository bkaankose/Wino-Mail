...
#nullable enable
        public List<global::Microsoft.Graph.Models.Security.DataSource>? AdditionalSources { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.Models.Security.DataSource> AdditionalSources { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.Models.Security.EdiscoveryAddToReviewSetOperation? AddToReviewSetOperation { get; set; }
#nullable restore
#else
        public global::Microsoft.Graph.Models.Security.EdiscoveryAddToReviewSetOperation AddToReviewSetOperation { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Models.Security.DataSource>? CustodianSources { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.Models.Security.DataSource> CustodianSources { get; set; }
#endif
        ...
        public global::Microsoft.Graph.Models.Security.DataSourceScopes? DataSourceScopes { get; set; }
        /// <summary>The last estimate operation associated with the eDiscovery search.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.Models.Security.EdiscoveryEstimateOperation? LastEstimateStatisticsOperation { get; set; }
#nullable restore
#else
        public global::Microsoft.Graph.Models.Security.EdiscoveryEstimateOperation LastEstimateStatisticsOperation { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Models.Security.EdiscoveryNoncustodialDataSource>? NoncustodialSources { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.Models.Security.EdiscoveryNoncustodialDataSource> NoncustodialSources { get; set; }
#endif
