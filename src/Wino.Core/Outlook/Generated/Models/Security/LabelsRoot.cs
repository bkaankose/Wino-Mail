...
#nullable enable
        public List<global::Microsoft.Graph.Models.Security.AuthorityTemplate>? Authorities { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.Models.Security.AuthorityTemplate> Authorities { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Models.Security.CategoryTemplate>? Categories { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.Models.Security.CategoryTemplate> Categories { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Models.Security.CitationTemplate>? Citations { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.Models.Security.CitationTemplate> Citations { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Models.Security.DepartmentTemplate>? Departments { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.Models.Security.DepartmentTemplate> Departments { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Models.Security.FilePlanReferenceTemplate>? FilePlanReferences { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.Models.Security.FilePlanReferenceTemplate> FilePlanReferences { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Models.Security.RetentionLabel>? RetentionLabels { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.Models.Security.RetentionLabel> RetentionLabels { get; set; }
#endif
