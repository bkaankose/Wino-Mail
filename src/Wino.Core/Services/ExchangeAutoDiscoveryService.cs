...
/// <summary>
/// Discovers EWS endpoints with Exchange Autodiscover V2, trying the candidates Outlook tries: the
/// directory service connection point (domain-joined machines), the DNS SRV record, then the
/// well-known HTTPS hosts. Many organisations publish only the SRV record.
/// </summary>
