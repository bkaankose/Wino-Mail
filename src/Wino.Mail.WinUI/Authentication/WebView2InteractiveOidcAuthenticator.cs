...
/// <summary>
/// Interactive OIDC sign-in hosted in an embedded WebView2. The redirect (an https reply URL by
/// convention, the way OWA registers it) is captured in-process, so no loopback listener is needed.
/// </summary>
