...
public abstract class WinoSynchronizer<TBaseRequest, TMessageType, TCalendarEventType> : BaseSynchronizer<TBaseRequest>, IWinoSynchronizerBase
{
                    ...
                    if (key is CalendarSynchronizerOperation calendarSynchronizerOperation)
                    {
                        switch (calendarSynchronizerOperation)
                        {
                            ...
                            case CalendarSynchronizerOperation.UpdateEvent:
                                ...
                                break;
                            case CalendarSynchronizerOperation.UpdateEventPersonalOptions:
                                nativeRequests.AddRange(group
                                    .OfType<UpdateCalendarEventPersonalOptionsRequest>()
                                    .SelectMany(UpdateCalendarEventPersonalOptions));
                                break;
    ...
    public virtual List<IRequestBundle<TBaseRequest>> UpdateCalendarEventPersonalOptions(UpdateCalendarEventPersonalOptionsRequest request) => throw new NotSupportedException(string.Format(Translator.Exception_UnsupportedSynchronizerOperation, this.GetType()));
