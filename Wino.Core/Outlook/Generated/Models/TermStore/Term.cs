...
#nullable enable
        public List<global::Microsoft.Graph.Models.TermStore.Term>? Children { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.Models.TermStore.Term> Children { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Models.TermStore.LocalizedDescription>? Descriptions { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.Models.TermStore.LocalizedDescription> Descriptions { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Models.TermStore.LocalizedLabel>? Labels { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.Models.TermStore.LocalizedLabel> Labels { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Models.KeyValue>? Properties { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.Models.KeyValue> Properties { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Microsoft.Graph.Models.TermStore.Relation>? Relations { get; set; }
#nullable restore
#else
        public List<global::Microsoft.Graph.Models.TermStore.Relation> Relations { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Microsoft.Graph.Models.TermStore.Set? Set { get; set; }
#nullable restore
#else
        public global::Microsoft.Graph.Models.TermStore.Set Set { get; set; }
#endif
