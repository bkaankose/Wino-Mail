                    ...
                    IAppShellService appShellService) : IThemeService
{
    ...
    private readonly IApplicationResourceManager<ResourceDictionary> _applicationResourceManager = applicationResourceManager;
    private readonly IAppShellService _appShellService = appShellService;

    private List<AppThemeBase> _preDefinedThemes{ get; } =
    [
    ...
    public async Task ApplyCustomThemeAsync(bool isInitializing)
    {
        ...
        List<AppThemeBase> controlThemeList = [.. _preDefinedThemes];
    ...
    {
        List<AppThemeBase> availableThemes = [.. _preDefinedThemes];
